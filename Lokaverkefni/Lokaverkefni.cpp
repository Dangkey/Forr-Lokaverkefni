...
{	
	Sjoppa shop[10];
	shop[0] = Sjoppa("Pensill            ", 999,"  Malningadeild");
	shop[1] = Sjoppa("Blondud malning 1L ",  1500," Malningadeild");
	shop[2] = Sjoppa("Blondud malning 5L ", 6500," Malningadeild");
	shop[3] = Sjoppa("Blondud malning 10L", 11490,"Malningadeild");
	shop[4] = Sjoppa("Vir 1M             ", 300,"   Rafindadeild");
	shop[5] = Sjoppa("Netsnura 5M        ", 1500,"  Rafindadeild");
	shop[6] = Sjoppa("HDMI Snura 10M     ", 2000,"  Rafindadeild");
	shop[7] = Sjoppa("Klo                ", 500,"   Rafindadeild");
	shop[8] = Sjoppa("Tenglarenna        ", 300000,"Rafindadeild");
	shop[9] = Sjoppa("Twix               ", 999,"        Almennt");
	for (int i = 0; i < 10; i++)
	{
		shop[i].print();
	}
